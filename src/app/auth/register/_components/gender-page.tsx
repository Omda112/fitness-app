    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      ...
      <div className="flex gap-6 mb-8">
        ...
        variant="outline"
          ...
          className={cn(
            'w-32 h-32 rounded-full border-3 flex flex-col items-center justify-center gap-2 transition-all duration-300',
        ...
        >
          {/* Mars Icon */}
          <Mars className="size-10 text-white -rotate-45" />
          <span className="text-white font-medium text-lg">{t('auth.register.gender.male')}</span>
        </Button>
        ...
        >
          {/* Venus Icon */}
          <Venus className="size-10 text-white" />
      ...
      <Button
        onClick={handleNext}
        className={cn(
          'font-semibold py-3 px-24 rounded-full transition-all duration-300 shadow-lg',
          form.watch('gender')
            ? 'bg-[#FF4100] hover:bg-[#FF4100]/90 text-white'
